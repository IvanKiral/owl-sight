...
import {
	type VideoExtractionArgs,
	createYtDlpExtractVideoArgs,
...
export type YtDlpVideoOptions = Partial<
	Pick<
		VideoExtractionArgs,
		"quality" | "format" | "mergeOutputFormat" | "quiet" | "cookies"
	>
>;
...
export const downloadDataFromVideo = async (
	...
	WithError<{ videoFilePath: string; metadataFilePath: string }, string>
> => {
